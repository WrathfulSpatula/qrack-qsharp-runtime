...
namespace Microsoft.Quantum.Simulation.Simulators.Tests
{
    ...
    public class IntrinsicTests
    {
        ...
        public void CCNOT()
        {
            ...
            var op = new QrackSimulator().Get<Intrinsic.CCNOT>();
        ...
        {
            var target = new FreeQubit(0);
            var op = new QrackSimulator().Get<Intrinsic.Ry>();
        ...
        public void M()
        {
            ...
            var op = new QrackSimulator().Get<Intrinsic.M>();
    ...
    public class MeasurementTests
    {
        ...
        {
            var measureQubit = new FreeQubit(0);
            var op = new QrackSimulator().Get<Measurement.MResetX>();
            var args = op.__dataIn(measureQubit);
            var expected = new RuntimeMetadata()
            {
                Label = "MResetX",
    ...
    public class ControlledOpTests
    {
        ...
        public void ControlledH()
        {
            ...
            var op = new QrackSimulator().Get<Intrinsic.H>().Controlled;
        ...
        public void ControlledX()
        {
            IQArray<Qubit> controls = new QArray<Qubit>(new[] { new FreeQubit(0) });
            Qubit target = new FreeQubit(1);
            var op = new QrackSimulator().Get<Intrinsic.X>().Controlled;
            var args = op.__dataIn((controls, target));
            var expected = new RuntimeMetadata()
            {
                Label = "X",
        ...
        public void ControlledCNOT()
        {
            ...
            var op = new QrackSimulator().Get<Intrinsic.CNOT>().Controlled;
    ...
    public class AdjointTests
    {
        ...
        {
            Qubit target = new FreeQubit(0);
            var op = new QrackSimulator().Get<Intrinsic.H>().Adjoint;
            var args = op.__dataIn(target);
            var expected = new RuntimeMetadata()
            {
                Label = "H",
        ...
        {
            Qubit target = new FreeQubit(0);
            var op = new QrackSimulator().Get<Intrinsic.X>().Adjoint;
            var args = op.__dataIn(target);
            var expected = new RuntimeMetadata()
            {
                Label = "X",
        ...
        public void ControlledAdjointH()
        {
            IQArray<Qubit> controls = new QArray<Qubit>(new[] { new FreeQubit(0) });
            Qubit target = new FreeQubit(1);
            var op1 = new QrackSimulator().Get<Intrinsic.H>().Controlled.Adjoint;
            var op2 = new QrackSimulator().Get<Intrinsic.H>().Adjoint.Controlled;
